...
$modcapquizfolder = new admin_category('modcapquizfolder', new lang_string('pluginname', 'capquiz'), !$module->is_enabled());
...
$ADMIN->add('modcapquizfolder', new admin_category(
    name: 'capquizreportplugins',
    visiblename: new lang_string('reportplugin', 'capquiz'),
    hidden: !$module->is_enabled(),
));
